...
| 002 | Personal-task agent loop (autonomous + standup, less meta) | discuss | ready | — |
...
| 009 | Today list — task drag parity (reorder + cross-section) | review | ready | — |
...
| 012 | Today view — drag panels to swap sides | review | ready | — |
