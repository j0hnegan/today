...
- **[Draft PR #13](https://github.com/j0hnegan/today/pull/13) "Native iOS app shell (Capacitor) [WIP]"**
  (`feat/ios-capacitor`) — **27 days** open (since 2026-05-31), no backlog folder. Options:
...
- No backlog features untouched >30 days (oldest active: 011-search, 2026-06-07, 18 days).
